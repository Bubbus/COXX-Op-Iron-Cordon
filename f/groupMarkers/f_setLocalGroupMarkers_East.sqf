...
// MARKERS: OPFOR > CSAT
// Markers seen by players in CSAT
...
["UnitCSAT_CO_DC",_hq, "DC", "ColorYellow"] spawn f_fnc_localSpecialistMarker;
["UnitCSAT_CO_FAC",_hq, "FAC", "ColorYellow"] spawn f_fnc_localSpecialistMarker;
